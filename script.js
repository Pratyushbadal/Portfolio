...
function handleFormSubmit(e) {
  ...
  setTimeout(() => {
    status.textContent =
      "✅ Your email client should have opened. If not, email me directly at info@pratyushbadal.com.np";
    btn.innerHTML =
      'Open Email App <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="22" y1="2" x2="11" y2="13"/><polygon points="22 2 15 22 11 13 2 9 22 2"/></svg>';
    btn.disabled = false;
